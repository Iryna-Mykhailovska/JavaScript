...
let num1 = 0.1;
let num2 = 0.2;
let sum = Math.round((num1 + num2) * 10) / 10;
console.log(sum);
alert(sum);
// ========================================
...
// ========================================
/* Що повернуть вирази:
 2 && 0 && 3 шукаєть перше хибне значення, якщо всі істинні, то повертають останнє значення.
 2 || 0 || 3 шукаєть перше істинне значення, якщо всі хибні, то повертають останнє значення.
 2 && 0 || 3 спочатку виконується логічне І, потім логічне АБО. Логічне І повертає 0, потім логічне АБО повертає 3.
*/
